    ...
    public function up()
    {
        if (!Schema::hasTable('enrollment_regiment_form')) {
            Schema::create('enrollment_regiment_form', function (Blueprint $table) {
                ...
                $table->longText('treatment_history')->nullable();
                ...
                $table->longText('clinical_status')->nullable();
                $table->longText('signs_and_symptoms')->nullable();
                $table->longText('vital_signs')->nullable();
                $table->longText('diag_and_lab_findings')->nullable();
                $table->timestamps();
            });
        }
    }
