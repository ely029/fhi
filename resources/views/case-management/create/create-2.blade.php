    ...
    <table class="table table--unset js-table-unset">
        ...
        <tr class="table__row">
            ...
            <div class="form__content">
                ...
                <label class="form__label" for="">Method used </label>
            </div>
            </td>
            <td class="table__details">
            <div class="form__content">
                ...
                <table class="table table--unset js-table-unset">
                  ...
                  <tbody>
                    <tr class="table__row">
                      ...
                      <td class="table__details"><input class="form__input form__input--full" type="date" /><span class="with-errors with-errors--table">errow</span></td>
                      <td class="table__details">
                        <div class="form__content">
                          <select class="form__input form__input--select form__input--full">
                            <option> </option>
    ...
    <table class="table table--unset js-table-unset" id="screening-table-1">
        ...
        <tr class="table__row form-step-2">
            ...
            <div class="form__content">
                ...
                <option value="Truenat TB">Truenat TB</option>
                </select>
                <div class="triangle triangle--down"></div>
            </div>
            </td>
        ...
        <tr class="table__row screening-2 form-step-2">
            ...
            <input class="form__input form__input--full" id="screening_2_date" type="date" name=""/></td>
            <td class="table__details">
            <div class="form__content">
