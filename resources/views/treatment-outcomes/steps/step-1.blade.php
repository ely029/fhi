<div class="form__tab step-1">
    ...
    <div class="grid grid--two form-step-1">
      <div class="form__content form-group">
          <input class="form__input" id="firstName" type="text" placeholder="First name" disabled name="first_name"/>
          <div class="help-block with-errors"></div>
          <label class="form__label" for="">First name</label>
        </div>
      <div class="form__content form-group">
          <input class="form__input" id="middleName" type="text" placeholder="Middle name" disabled name="middle_name"/>
          <div class="help-block with-errors"></div>
