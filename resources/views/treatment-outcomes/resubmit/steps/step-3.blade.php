<div class="form__tab step-3">
    <div class="form__container">
      ...
      <div class="form__container">
        <div class="grid">
          <div class="form__content form__content--small form__content--small__right">
            <input class="form__input" type="date" placeholder="CT scan date" name="ct_scan_date" value="{{ $tbMacForm->laboratoryResults->ct_scan_date ? $tbMacForm->laboratoryResults->ct_scan_date->format('Y-m-d') : '' }}"/>
            <label class="form__label" for="">CT scan date</label>
          </div>
          <div class="form__content">
            <input class="form__input" type="text" placeholder="CT scan result" name="ct_scan_result" value="{{ $tbMacForm->laboratoryResults->ct_scan_result }}"/>
      ...
      <div class="form__container">
        <div class="grid">
          <div class="form__content form__content--small form__content--small__right">
            <input class="form__input" type="date" placeholder="Ultrasound date" name="ultrasound_date" value="{{ $tbMacForm->laboratoryResults->ultrasound_date ? $tbMacForm->laboratoryResults->ultrasound_date->format('Y-m-d') : '' }}" />
            <label class="form__label" for="">Ultrasound date</label>
          </div>
          <div class="form__content">
            <input class="form__input" type="text" placeholder="Ultrasound result" name="ultrasound_result" value="{{ $tbMacForm->laboratoryResults->ultrasound_result }}"  />
      ...
      <div class="form__container">
        <div class="grid">
          <div class="form__content form__content--small form__content--small__right">
            <input class="form__input" type="date" placeholder="Histopathological date" name="histopathological_date" value="{{ $tbMacForm->laboratoryResults->histopathological_date ? $tbMacForm->laboratoryResults->histopathological_date->format('Y-m-d') : '' }}" />
            <label class="form__label" for="">Histopathological date

            </label>
          </div>
          <div class="form__content"><input class="form__input" type="text" placeholder="Histopathological result" name="histopathological_result" value="{{ $tbMacForm->laboratoryResults->histopathological_result }}" />
