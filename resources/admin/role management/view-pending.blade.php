            ...
            <div class="modal js-modal">
              ...
              <div class="modal__container">
                <div class="modal__box">
                  ...
                  <p class="modal__text">By declining this admin, you're require to leave a remarks.</p>
                  <form class="form">
                  ...
                  <div class="modal__button"><input class="button" type="submit" value="Send message" /></div>
                </div>
              </div>
            </div>
          </form>
