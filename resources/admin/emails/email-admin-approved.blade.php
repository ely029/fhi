<div class="email" style="background-color: #ebebeb;
  ...
  font-size: 20px;margin-top: 0;">Hi [name]</p>
        <p class="email__text" style="color: #000;
  font-size: 20px;margin: 30px 0;text-align: justify;">Your request for Secretariat role has been approved. Please click the button below to proceed on this role.</p>
