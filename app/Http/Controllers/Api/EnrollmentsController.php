...
class EnrollmentsController extends Controller
{
    ...
    protected function rules()
    {
        return [
            ...
            'clinical_status' => 'required_if:drug_susceptibility,Clinically-diagnosed MDR-TB',
            'signs_and_symptoms' => 'required_if:drug_susceptibility,Clinically-diagnosed MDR-TB',
            'vital_signs' => 'required_if:drug_susceptibility,Clinically-diagnosed MDR-TB',
            'diag_and_lab_findings' => 'required_if:drug_susceptibility,Clinically-diagnosed MDR-TB',
