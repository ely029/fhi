...
class MasterListController extends Controller
{
    public function index()
    {
        ...
        $caseManagement = DB::table('tb_mac_forms')
            ...
            ->select('tb_mac_forms.status as header_status', 'case_management_regiment_form.remarks', 'tb_mac_forms.presentation_number', 'recommendation.status as recom_status', 'patients.first_name', 'patients.middle_name', 'patients.last_name', 'patients.birthday', 'tb_mac_forms.updated_at', 'patients.gender')
        ...
        $treatmentOutcome = DB::table('tb_mac_forms')
            ...
            ->select('tb_mac_forms.status as header_status', 'laboratory_results.remarks', 'tb_mac_forms.presentation_number', 'recommendation.status as recom_status', 'patients.first_name', 'patients.middle_name', 'patients.last_name', 'patients.birthday', 'tb_mac_forms.updated_at', 'patients.gender')
