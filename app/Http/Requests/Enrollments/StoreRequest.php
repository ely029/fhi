...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'clinical_status' => 'required_if:drug_susceptibility,Clinically-diagnosed MDR-TB|max:1000',
            'signs_and_symptoms' => 'required_if:drug_susceptibility,Clinically-diagnosed MDR-TB|max:255',
            'vital_signs' => 'required_if:drug_susceptibility,Clinically-diagnosed MDR-TB|max:255',
            'diag_and_lab_findings' => 'required_if:drug_susceptibility,Clinically-diagnosed MDR-TB|max:255',
